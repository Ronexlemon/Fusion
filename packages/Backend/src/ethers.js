...
//   } from './constant/constants'
  const {ACCOUNTS_CONTRACT,
    ...
    ODIS_PAYMENTS_CONTRACT,
    ODIS_PAYMENTS_PROXY_ADDRESS,
    STABLE_TOKEN_CONTRACT,} = require("./constants")
...
const DEK_PUBLIC_KEY = process.env.DEK_PUBLIC_KEY;
const DEK_PRIVATE_KEY = process.env.ISSUER_PRIVATE_KEY;
  ...
  class ASv2 {
    provider = new ethers.JsonRpcProvider(ALFAJORES_RPC)
